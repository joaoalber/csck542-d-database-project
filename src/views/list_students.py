...
tk.Button(frame_left, text="High-rated students", command=filter_top_students).pack(pady=5, padx=5)
tk.Button(frame_left, text="Not enrolled yet", command=filter_not_enrolled_students).pack(pady=5, padx=5)
tk.Button(frame_left, text="All students", command=all_students).pack(pady=5, padx=5)
